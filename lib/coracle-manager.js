...
export default {
 ...
 sendLogin(userName,userPwd) {
   ...
   var url = package.host+"/cormobi/ide/svnLogin?username="+userName+"&password="+userPwd;
 ...
 requestAppId(appKey,done){
  xmlHttp = this.createXMLHttpRequest();
  var url = package.host+"/cormobi/ide/getProjectIdByAppId/"+appKey;
  var params = {
  };
 ...
 sendCreatApp(appInfo,done){
  xmlHttp = this.createXMLHttpRequest();
   var url = package.host+"/cormobi/project/saveProject";
   var params = {
