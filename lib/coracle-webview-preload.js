...
(function (global, nodeRequire, undefined) {
  ...
  */
  ...
  CoracleStudio.createCoUIPro = function (date) {
    ipcRenderer.sendToHost('create-CoUIModule',date);
  }

  CoracleStudio.createCoUIProject = function (date) {
    ipcRenderer.sendToHost('create-CoUIProject',date);
  }

  CoracleStudio.addPage = function (date) {
    ipcRenderer.sendToHost('create-CoUIAddPage',date);
  }
