...
export default {
 ...
 sendLogin(userName,userPwd) {
   ...
   var url = package.host+"/portal2/ide/svnLogin?username="+userName+"&password="+userPwd;
 ...
 requestAppId(appKey,done){
  xmlHttp = this.createXMLHttpRequest();
  var url = package.host+"/portal2/ide/getProjectIdByAppId/"+appKey;
  var params = {
  };
 ...
 sendCreatApp(appInfo,done){
  xmlHttp = this.createXMLHttpRequest();
   var url = package.host+"portal2/project/saveProject";
   var params = {
