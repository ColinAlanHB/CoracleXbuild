...
export default {
  ...
  opener (url) {
      ...
      if (urlInfo.protocol == 'coracle-create:') {
        this.corWebView.setUri(package.host+'/portal2/ide/project.html');
        return this.corWebView;
      }

      if (urlInfo.protocol == 'coracle-login:') {
        this.corWebView.setUri(package.host+"/portal2/login");
        return this.corWebView;
      }

      if (urlInfo.protocol == 'coracle-welcome:') {
        this.corWebView.setUri(package.host+"/portal2/ide/welcome.html");
        return this.corWebView;
      }

      if (urlInfo.protocol == 'coracle-cloud:') {
        console.log(package.host+'/portal2/console/hybrid/'+urlInfo.query+'/compile');
        this.corWebView.setUri(package.host+'/portal2/console/hybrid/'+urlInfo.query+'/compile');
        return this.corWebView;
      }

      if (urlInfo.protocol == 'coracle-cloud-build-apprunner:') {
        console.log(package.host+'/portal2/console/hybrid/'+urlInfo.query+'/plugin?type=3');
        this.corWebView.setUri(package.host+'/portal2/console/hybrid/'+urlInfo.query+'/plugin?type=3');
        return this.corWebView;
      }

      if (urlInfo.protocol == 'coracle-module:') {
        console.log(package.host+'/portal2/console/hybrid/'+urlInfo.query+'/plugin');
        this.corWebView.setUri(package.host+'/portal2/console/hybrid/'+urlInfo.query+'/plugin');
        return this.corWebView;
      }

      if (urlInfo.protocol == 'coracle-sync:') {

        this.corWebView.setUri(package.host+'/portal2/ide/sync.html');
        return this.corWebView;
      }
